...
import { StrokeColorSidebar } from "@/features/editor/components/fill-stoke-color-sidebar";
import { StrokeWidthSidebar } from "@/features/editor/components/fill-stoke-width-sidebar";
import { OpacitySidebar } from "@/features/editor/components/fill-opacity-sidebar";
  ...
  useEffect(() => {
    const canvas = new fabric.Canvas(
      canvasRef.current,
      {
        ...
        // preserveObjectStacking will affect the order of objects in the canvas when we click on them
